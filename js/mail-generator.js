...
// pushes a message using the generateMessage function below to add an email to geemails array below.
...
// a function to return an object that contains a date, subject, sender, and message body, based on a random number generated by the getRandomElement function below.
...
// returns a random index from an array.
  ...
  // returns a new object that contains today's date, subject, sender, and a message body based on a random number generated by the getRandomElement and the getRandomDate function below.
  ...
  // returns a random date that can be used by the getNewMessage function above.
